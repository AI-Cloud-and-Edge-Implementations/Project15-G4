...
class FileSegmenter:
    ...
    @staticmethod
    def segment_file(
            filename, metadata, slack_time, train_or_test, delete_data: bool = False,
            create_spectrograms: bool = False
    ):
        ...
        for index, metadata_segment in metadata_segments.iterrows():
            try:
                ...
                segment_path = \
                    f'data/segments/{train_or_test}/{filename}_segment_{selection}_{marginal}.wav'
                ...
                if os.path.exists(segment_path):
                    ...
                    print(
                        f' Found segment of {segment.duration_seconds} seconds, '
                        f'exported to {segment_path}.'
                    )
